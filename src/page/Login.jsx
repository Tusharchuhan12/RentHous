...
import { FaArrowLeft, FaArrowRight, FaEye, FaEnvelope } from "react-icons/fa";
...
export default function Login() {
    ...
    return (
        <div className="bg-white min-h-screen mb-5">
            ...
            {/* Main */}
            <main className="flex flex-col md:flex-row max-w-7xl mx-auto mt-10 px-6 md:px-12 lg:px-16">
                {/* Right Section - Image (mobile pe upar) */}
                <section className="order-1 md:order-2 md:w-1/2 mt-10 md:mt-0 md:pl-12 flex justify-center">
                    <img
                ...
                {/* Left Section - Form (mobile pe niche) */}
                <section className="order-2 md:order-1 md:w-1/2 max-w-md">
                        ...
                        <div className="flex items-center justify-between text-xs text-gray-500">
                            <label className="flex items-center gap-1 select-none">
                                <input
                                    type="checkbox"
                                    name="remember"
                                    className="w-3.5 h-3.5 border border-gray-300 rounded-sm"
                                />
                                Remember Me
                            </label>
                    ...
                    <div className="flex items-center justify-center gap-10 text-2xl">
                        ...
                        <button
                            ...
                            className="text-[#1877F2] hover:text-[#145dbf]"
                        >
                            <FaFacebookF />
                        </button>
                        <button
